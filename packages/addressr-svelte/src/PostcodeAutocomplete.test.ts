...
import PostcodeAutocomplete from './PostcodeAutocomplete.svelte';
...
describe('PostcodeAutocomplete (Svelte)', () => {
  ...
  it('calls onSelect with the PostcodeSearchResult when option chosen', async () => {
    ...
    render(PostcodeAutocomplete, { props: { debounceMs: 10, fetchImpl: mockFetch, onSelect } });
