...
import LocalityAutocomplete from './LocalityAutocomplete.svelte';
...
describe('LocalityAutocomplete (Svelte)', () => {
  ...
  it('calls onSelect with the LocalitySearchResult when option chosen', async () => {
    ...
    render(LocalityAutocomplete, { props: { debounceMs: 10, fetchImpl: mockFetch, onSelect } });
