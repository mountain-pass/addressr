...
// TDD cycle: /api-docs schemas and examples

describe('postcode accumulation', () => {
  it('should export searchForPostcode function', async () => {
    const service =
      await import('../../packages/addressr/service/address-service.js');
...
describe('locality index', () => {
  it('should export initLocalityIndex function', async () => {
    const client =
      await import('../../packages/addressr/client/elasticsearch.js');
