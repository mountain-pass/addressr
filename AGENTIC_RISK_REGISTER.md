...
| AR1     | `C-AR1-C4-ARCHITECTURE-DRIFT-GATE` (manual advisory; no deterministic control credit under ADR-051)                                                                                                                                                                                                                                                                                                              | `docs/architecture/C4_MODEL.md`, `AGENTS.md`, architecture review evidence     |
...
| AR15    | `C-AR15-APP-CORRECTNESS-UNIT-GATE`, `C-AR15-EVENT-SCHEMA-VALIDATION`, `C-AR15-TEST-OBLIGATION-GATE`, `C-AR15-CHANGED-LINES-COVERAGE`, `C-AR15-PER-FILE-COVERAGE-RATCHET`, `C-AR15-WORKBOOK-PARITY-GATE`, `C-AR15-MIGRATION-CONTRACT-GATE`, `C-AR15-ROSTER-IDENTITY-COLLISION-GATE`, `C-AR15-LIVE-PERFORMANCE-GATE`, `C-AR15-A11Y-WCAG-GATE`, `C-AR15-A11Y-CONTRAST-GATE`, `C-AR15-WEBSITE-CSS-REACHABILITY-GATE` | app and website tests, quality gates, CI workflows                             |
...
- Bidirectional site-owned CSS reachability gate over Gatsby output and hydrated browser states (`apps/website/test/css-reachability.mjs`) in the website build job
- Manual C4 architecture review for architecture-bearing changes; advisory only, with no deterministic control credit under ADR-051
