---
'@mountainpass/addressr-react': patch
'@mountainpass/addressr-deployment': patch
'@mountainpass/website': patch
---

Replace the website's bespoke address demo with the published React autocomplete components, adding live address, suburb or town, postcode, and state or territory examples with visible and announced selections.
