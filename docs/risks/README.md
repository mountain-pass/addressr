...
| [R020](R020-deploy-path-push-tier-prod-deploy-precondition-unmet.active.md)                  | Manual `deploy_only` recovery path never exercised (absorbs R025)     | operational | 12       | 8        | Mitigate  | addressr-maintainer | 2027-02-04 |
...
| [R022](R022-unstaged-deploy-tf-drift-arms-push-tier-prod-apply.active.md)                    | Unstaged deploy/**.tf drift arms a push-tier prod apply (re-scoped)   | operational | 15       | 5        | Mitigate  | addressr-maintainer | 2027-02-04 |
