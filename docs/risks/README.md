...
| [R020](R020-deploy-path-push-tier-prod-deploy-precondition-unmet.active.md)           | `deploy_only` path exercised 2026-08-05, against a no-op plan only (absorbs R025) | operational | 12       | 8        | Mitigate  | addressr-maintainer | 2027-02-04 |
| [R021](R021-push-tier-deploy-axis-arms-prod-terraform-apply.active.md)                | Push-tier deploy axis: production apply at the lowest governance                  | operational | 15       | 10       | Mitigate  | addressr-maintainer | 2026-11-09 |
| [R022](R022-unstaged-terraform-lockfile-drift-arms-deploy-axis.active.md)             | Unstaged deploy/**.tf drift arms a push-tier prod apply (re-scoped)               | operational | 15       | 5        | Mitigate  | addressr-maintainer | 2027-02-04 |
