...
| [R021](R021-push-tier-deploy-axis-arms-prod-terraform-apply.active.md)                | Push-tier deploy axis: production apply at the lowest governance                  | operational | 15       | 5        | Accept    | addressr-maintainer | 2027-02-04 |
