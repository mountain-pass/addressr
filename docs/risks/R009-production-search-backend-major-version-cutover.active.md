...
- 2026-08-05: Cross-reference to R008 re-verified after R008 moved. The Siblings distinction — the same cutover event seen through the concurrency gap here and the relevance gap there — is untouched by R008's cross-reference verification bullet. Recorded per the review-fence check.
