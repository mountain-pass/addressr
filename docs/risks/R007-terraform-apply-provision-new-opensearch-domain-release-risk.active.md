...
- 2026-08-05: Cross-references to R021 and R022 re-verified after both moved. R021 gained a base-rate note and R022 recorded its live drift cleared; neither touches this entry's decomposition claim, that the trigger belongs to R015/R021/R020 and unreviewed apply content to R022, leaving the apply's _content_ here. Recorded per the review-fence check.
