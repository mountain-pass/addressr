# Risk R007: Terraform Apply Provision New Opensearch Domain Release Risk
...
Release-triggered terraform apply creating a new parallel OpenSearch prod domain on a new engine version scores 6/25 (Medium), above the 5 appetite; parallel-provision infra creation is a recurring standing release-risk shape across the v1→v2→v3 migration.
