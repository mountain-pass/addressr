...
- 2026-08-05: Cross-reference to R021 re-verified after R021 moved in the same sitting. This entry's claim — that P083's triage was wrong to fold it into R021, because R021 is about _who can start_ an apply while this one is about what an apply does — is unchanged by R021's edit, which corrected a stale Siblings clause about R020. Verification recorded rather than a touch: the review-fence check flags any entry referring to one that has since moved, and a verification is the answer it wants. Re-verified again later the same day after a further move; see the note below.
- 2026-08-05: Cross-reference to R021 re-verified after R021 recorded a fourth axis application. This entry's distinction — R021 is about who can start an apply, this one about what an apply does to EB once running — is untouched by a base-rate note. Recorded per the review-fence check.
