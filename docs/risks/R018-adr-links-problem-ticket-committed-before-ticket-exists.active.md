# Risk R018: Adr Links Problem Ticket Committed Before Ticket Exists
...
ADR-039 references docs/problems/open/067-no-sigterm-graceful-shutdown-handler.md in four places and the 18f0d9b Dockerfile references it too, but no P067 file exists; forward references to problem tickets are landing ahead of their targets with no link-checking control in pre-commit.
