...
- 2026-08-05: Cross-references to R022 and R004 re-verified after both moved in the same sitting. The likelihood reasoning here leans on R010, R022 and R004 for the discipline of not crediting a procedural control; R022 still declines its pathspec habit and R004's scoring is unchanged, so both citations hold. Recorded per the review-fence check. Re-verified again later the same day after a further move; see the note below.
- 2026-08-05: Cross-reference to R022 re-verified after R022 recorded its live `deploy/**` drift cleared. This entry cites R022 for the discipline of not crediting a procedural control; R022 explicitly holds its residual at 5 on the grounds that the class is untouched and the pathspec habit remains a habit, so the citation holds unchanged. Recorded per the review-fence check.
