...
| P026 | Numeric fuzziness in bool_prefix inflates ranking                  | 2026-04-20 | yes — observed: 2026-07-19 prod battery (P027 close) — exact-`138` sole hit, `Gazz` empty, `Muray`→MURRAY | `AUTO:5,8` fuzziness per ADR 027 (v2.4.0, commit 920fce6); ranking queries re-verified clean on OpenSearch 3.5; then comment on #367                                                                               |
