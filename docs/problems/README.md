...
> Last reviewed: 2026-09-19 **P152 captured** — the gateway cannot authenticate any managed session: the Clerk client is built without a secret key, `authenticateRequest` throws, and the catch flattens it to 401. Found by the local rehearsal harness booting the real bundle in workerd.
...
| ---- | ---- | ------------------------------------------------------------------------------------ | -------------- | ------------- | ------ | ---------- | ---------- |
| 20.0 | P152 | The gateway cannot authenticate any managed session                                  | Very High (20) | Open          | S      | 2026-09-19 | internal   |
| 12.0 | P144 | Email Routing's Terraform route blocked by a provider bug and token scope            | Medium (6)     | Known Error   | S      | 2026-09-06 | internal   |
...
| 6.0  | P150 | Customers cannot see or search their own request logs                                | High (12)      | Open          | M      | 2026-09-07 | maintainer |
