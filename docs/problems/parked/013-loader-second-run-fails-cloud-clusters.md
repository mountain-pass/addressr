...
- [`client/elasticsearch.js:111-143`](../../../packages/addressr/client/elasticsearch.js) — `initAddressIndex`, the update branch with the bug
- [`client/elasticsearch.js:230-260`](../../../packages/addressr/client/elasticsearch.js) — `initLocalityIndex`, likely same issue
