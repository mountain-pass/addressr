...
| fact                                                          | count |
| ------------------------------------------------------------- | ----- |
| test files that read a repo file and assert on what they read | 37    |
...
`.github/workflows` while explaining the rule — so run without the exclusion the rule returns 38 / 14 / 24
...
- [x] **Audit all `test/js/__tests__/*.test.mjs` files. DONE 2026-08-19: thirteen source pins read
      ...
      **Step 1 — 37 files read a repo file and assert on what they read.** Of those, **13 exercise the
                                                                                                                                                                                                  subject** (they import it, statically or dynamically, or spawn it) and **24 read only**. The first
                                                                                                                                                                                                  ...
                                                                                                                                                                                                  **Step 2 — of the 24 read-only files, NONE is a source-inspection test of implementation.** Ten
