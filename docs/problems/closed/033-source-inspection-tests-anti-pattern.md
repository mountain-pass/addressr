...
| fact                                                          | count |
| ------------------------------------------------------------- | ----- |
| test files that read a repo file and assert on what they read | 39    |
| of those, files that read `.github/workflows/**`              | 14    |
| all other file-reading test files                             | 25    |
...
`.github/workflows` while explaining the rule — so run without the exclusion the rule returns 40 / 15 / 25
...
Even now this over-counts the other group: `mutate-helper.test.mjs` is among the 25 and holds no source pin
...
- [x] **Audit all `test/js/__tests__/*.test.mjs` files. DONE 2026-08-19: thirteen source pins read
      ...
      **Step 1 — 39 files read a repo file and assert on what they read.** Of those, **14 exercise the
                                                                                                                                                                                                          subject** (they import it, statically or dynamically, or spawn it) and **25 read only**. The first
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          **Step 2 — of the 25 read-only files, NONE is a source-inspection test of implementation.** Ten
                                                                                                                                                                                                          read `.github/workflows/**`, where there is no runtime to exercise. The other fifteen check declarative
