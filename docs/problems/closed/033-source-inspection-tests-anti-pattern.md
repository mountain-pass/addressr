...
| fact                                                          | count |
| ------------------------------------------------------------- | ----- |
| test files that read a repo file and assert on what they read | 38    |
...
`.github/workflows` while explaining the rule — so run without the exclusion the rule returns 39 / 14 / 25
...
- [x] **Audit all `test/js/__tests__/*.test.mjs` files. DONE 2026-08-19: thirteen source pins read
      ...
      **Step 1 — 38 files read a repo file and assert on what they read.** Of those, **13 exercise the
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      **What this audit does NOT establish.** Three limits, the third of which was written because the
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      minus 9 read-only means **three already spawn a runtime**, so "there is no runtime in this repo to
