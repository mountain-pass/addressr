...
| of those, files that read `.github/workflows/**`              | 11    |
...
`.github/workflows` while explaining the rule — so run without the exclusion the rule returns 35 / 12 / 23
...
The eleven are `deploy-guard-surfaces`, `docker-image-workflow`, `gnaf-source-smoke`,
...
**The first version of this list, as at 2026-08-08, said nine and omitted `license-audit-runs-in-ci`** (the correct answer was ten at that date; the list says eleven again today for an unrelated reason — the perf-probe deletion of 2026-08-20 — so this sentence indicts the 2026-08-08 list, not the current one), because the predicate
...
**The conclusion that survives, and the one that does not.** Those eleven files pin YAML consumed by GitHub.
...
eleven spawn a runtime for something else, so the older wording "there is no runtime in this repo to feed
them" was true of eight files and is corrected below. **Restated 2026-08-20 (second pass):** this paragraph
...
- [x] **Audit all `test/js/__tests__/*.test.mjs` files. DONE 2026-08-19: thirteen source pins read
      ...
      **Step 1 — 34 files read a repo file and assert on what they read.** Of those, **13 exercise the
                                                                                                                                                                                      ...
                                                                                                                                                                                      **Step 2 — of the 21 read-only files, NONE is a source-inspection test of implementation.** Eight
                                                                                                                                                                                      ...
                                                                                                                                                                                      **What this audit does NOT establish.** Three limits, the third of which was written because the
                                                                                                                                                                                      ...
                                                                                                                                                                                      One correction to an earlier claim while these figures are being reconciled: 11 workflow-reading files
                                                                                                                                                                                      minus 8 read-only means **three already spawn a runtime**, so "there is no runtime in this repo to
                                                                                                                                                                                      feed them" is true of eight files, not eleven. Applied, not just noted: the two sites that carried that
                                                                                                                                                                                      wording are now phrased about the workflow PINS, for which the claim holds of all eleven. Recording the
