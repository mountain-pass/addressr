...
| fact                                                          | count |
| ------------------------------------------------------------- | ----- |
| test files that read a repo file and assert on what they read | 42    |
...
| all other file-reading test files | 28 |
...
`.github/workflows` while explaining the rule — so run without the exclusion the rule returns 43 / 15 / 28
...
Even now this over-counts the other group: `mutate-helper.test.mjs` is among the 28 and holds no source pin
...
- [x] **Audit all `test/js/__tests__/*.test.mjs` files. DONE 2026-08-19: thirteen source pins read
      ...
      **Step 1 — 42 files read a repo file and assert on what they read.** Of those, **15 exercise the
                                                                                                                                                                                                                                  subject** (they import it, statically or dynamically, or spawn it) and **27 read only**. The first
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  **Step 2 — of the 27 read-only files, NONE is a source-inspection test of implementation.** Ten
                                                                                                                                                                                                                                  read `.github/workflows/**`, where there is no runtime to exercise. The other seventeen check declarative
