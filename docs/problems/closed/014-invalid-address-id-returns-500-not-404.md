...
- [`service/address-service.js:1827`](../../../packages/addressr/service/address-service.js) — catch block with error detection
- [`src/waycharter-server.js:587`](../../../packages/addressr/src/waycharter-server.js) — itemLoader that consumes statusCode
