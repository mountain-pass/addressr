...
- [P033](033-source-inspection-tests-anti-pattern.md) — the sibling false-coverage class (runs but asserts on source text). Distinct mechanism, same reviewer trap.
