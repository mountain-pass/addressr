...
**Twelve of the 16 sit above appetite** — R006 and R021 at 10, R004 and R027 at 9, R003/R008/R009/R015/R020 at 8, R007, R012 and R028 at 6. Of the remaining four, two (R010, R022) sit exactly at 5, which is within appetite because the threshold is inclusive. R021 joined the partition on 2026-08-09, moving 5 → 10 when its Monitoring trigger fired; it is the first entry in this register to cross the line on a realised event rather than on a re-reading. R020 briefly read 4 on 2026-08-05 before the scorer withdrew the drop: exercising the path retired its plumbing sub-hazard only, and both exercises ran against a plan that changed nothing. R028 moved 8 → 6 in the same sitting when two mechanical checks landed; a first draft put it at 4 and within appetite, and the scorer withdrew that because one check covered a single phrasing and the other did not run in the gate at all.
