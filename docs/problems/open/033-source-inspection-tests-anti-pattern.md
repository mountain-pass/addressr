...
`.github/workflows` while explaining the rule — so run without the exclusion the rule returns 32 / 10 / 22
...
- [x] **Audit all `test/js/__tests__/*.test.mjs` files. DONE 2026-08-19: thirteen source pins read
      ...
      **Step 1 — 31 files read a repo file and assert on what they read.** Of those, **15 exercise the
