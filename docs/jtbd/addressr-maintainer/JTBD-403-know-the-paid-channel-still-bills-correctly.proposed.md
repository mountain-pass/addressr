...
screens:
  ...
  - 'test/js/__tests__/managed-channel-d1.test.mjs — the behavioural suite for the acting half, against real D1 under Miniflare. Listed here because it had no job home: it covers quota atomicity under concurrent reservation, settle and release, and from 2026-09-06 the property that a usage record retains no address identifier.'
