...
- **Out-of-band reachability is limited, and currently absent.** Email and SMS were chosen on 2026-09-03 and the SMS half was withdrawn unapplied on 2026-09-04. There is no on-call rotation and no paging tier on the account, and no fault notification is in place today. Whatever replaces it shortens time-to-awareness without ever becoming coverage.
