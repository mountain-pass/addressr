...
> **SUPERSEDED IN PART by [ADR 050](050-the-image-follows-the-publish-not-the-deploy.proposed.md).** The break-glass `npm run docker:push` route named here is withdrawn as a sanctioned manual path.
