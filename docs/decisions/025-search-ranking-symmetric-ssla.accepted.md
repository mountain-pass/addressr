...
- [Problem 074 — P007 street-level-first is unfixed for ~50% of addresses with sub-units](../problems/verifying/074-p007-street-level-first-unfixed-for-half-of-sub-unit-addresses.md) — measured this ADR's Decision Driver 1 violated at 62.7% while every recorded gate stayed green
