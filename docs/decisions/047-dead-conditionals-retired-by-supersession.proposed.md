...
- **P039** (`docs/problems/closed/039-decouple-saas-deployment-from-npm-publish.md`) — carries the changeset guard's implementation notes, including why the refusal deliberately omits `deploy_only`.
