...
- **ADR-053** — website imported as an app with hosting unchanged. **Navigational cross-reference only, added 2026-08-23** (`DECISION-MANAGEMENT.md` § What May Be Amended At All): it carries no substance and changes nothing this record decides. It is where the first reassessment criterion above — _"`apps/website` lands"_ — was answered, and where Confirmation criterion 4 converts from inspection to assertion on the third workspace entry.
