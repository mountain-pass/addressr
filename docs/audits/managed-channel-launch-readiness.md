...
- **As at:** 2026-09-03, after the RapidAPI 4xx counter observation
...
Next step: re-read the team application's console counter at least 24 hours
after 2026-09-03 06:46 UTC and record the delta. Leave 5xx untested unless it
can be observed without deliberately disrupting a live service.
